...
Telemetría conceptual, eventos, economy hooks futuros, retención, patch notes, release checklist. Subagente Cursor: `agents/liveops/liveops.md` (enlazado en `.cursor/agents/liveops.md`). Skills: `skills/live-event-concept-brief/`, `telemetry-planning/`, `retention-loop-checklist/`, `patch-note-template/`, `release-readiness-review/`.
